...
function Certificates()  {
  ...
  return (
    ...
    <div className="fundo-branco">
          <img  className="logo-cert" src={fotologo} alt="Be The Hero" />
         <header id="cabecalho"/>
        ...
        <h1 className="titulo-cert">Certificado de Adoção</h1>
            ...
            <h4 className="subtext-cert">CERTIFICAMOS QUE {nomeCompleto} CPF {cpf}</h4>  
              <h4 className="subtext-cert">QUE RESIDE NO ENDEREÇO {endereco}</h4>
                    <h4 className="subtext-cert"> ADOTOU O GATINHO(a)</h4>  
         <div>
