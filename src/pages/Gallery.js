  ...
  <div className="container">
    <div className="grid-container">
      <div className="grid-iten">
        <div className="zoom">
         {/*} <img src="" alt="gato1" />*/}
          <img className="gatoimg" src={gato1} alt="gato1" /> 
        </div>
        ...
        <div>    
          ...
          <Link to="/form/1"><button className="submit" type="submit" onclick="window.location.href='/Form.js'">Quero adotar</button></Link>
        </div>
      </div>
      <div className="grid-iten">
        <div className="zoom">
         {/*} <img src="./Galeria/Gatos/Gato 2.jpg" alt />*/}
         <img className="gatoimg" src={gato2} alt="gato2" /> 
        </div>
        <div className="legenda">
        ...
        <br /> 
          ...
          <div>
          <button className="buttons" type="button"onClick={()=> mostrarMenssagem ()} >Conheça a minha história</button> 
          <Link to="/form/1"><button className="submit" type="submit" >Quero adotar</button></Link>
          </div>
        </div>
      ...
      <div className="grid-iten">
        <div className="zoom">
          ...
          <img className="gatoimg" src={gato3} alt="gato3" /> 
        </div>
        <div className="legenda">
      ...
      <div className="grid-iten">
        <div className="zoom">
          ...
          <img className="gatoimg" src={gato4} alt="gato3" /> 
        </div>
        <div className="legenda">
      ...
      <div className="grid-iten">
        ...
        <img className="gatoimg" src={gato5}  alt="gato5" /> 
        </div>
        <div className="legenda">
      ...
      <div className="grid-iten" id>
        <div className="zoom">
          ...
          <img className="gatoimg" src={gato6} alt="gato6" /> 
        </div>
        <div className="legenda">
